...
class PokemonService(metaclass=Singleton):
    ...
    def get_pokemon_from_webservice(self, limit:int=100, offset:int=0) -> List[AbstractPokemon]:
        """
    ...
    def get_pokemon_with_identifier_from_webservice(self, identifier:Union[int, str]) -> AbstractPokemon:
